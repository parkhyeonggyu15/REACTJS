...
export function ScssBox() {
  ...
  return <div className="scss-box"><span>scss-box</span></div>;
}
...
export function BootstrapKit() {
  ...
  return (
    <Card style={{ width: "20rem" }}>
      <Card.Body>
        <Card.Title>
          공지 <Badge bg="secondary">NEW</Badge>
        </Card.Title>
        <Alert variant="info">알림 메시지</Alert>
    ...
    <div>
      ...
      <Container className="mt-3">
        <Row>
          <Col md={4}>
            <Card>
              <Card.Body>사이드 메뉴</Card.Body>
            </Card>
          </Col>
          <Col md={8}>
            <Card>
              <Card.Body>본문 콘텐츠</Card.Body>
            </Card>
          </Col>
        </Row>
      </Container>
...
function SectionBS({ children }) {
  return (
    <Col>
      <div className="border p-3">{/* {TODO} children */}
        {children}
      </div>
    </Col>
  );
...
function Aside7() {
  ...
  return <ListGroup>
    <ListGroup.Item action>1</ListGroup.Item>
    <ListGroup.Item action>2</ListGroup.Item>
    <ListGroup.Item action>3</ListGroup.Item>
  </ListGroup>;
}
