...
// ---------------------------------------------------------------------
function Child1(/* {TODO} props 받기 */ props) {
  // {TODO} title 출력
  
  return <p>자식이 받은 title : {props.title}</p>;
}
...
function Child2({ onSend }) {
  ...
  return (
    <div>
      ...
      <input type="text" placeholder="부모에게 보낼 메시지" value={value} onChange={(e)=>{setValue(e.target.value)}}/>
