...
export function Counter() {
  ...
  return (
    <div>
      ...
      <button onClick={handlerClick }>BTN Count : {count}</button>
      <button onClick={ handlerClick2}>BTN Count2 : {count}</button>
      <button onClick={handlerClick3 }>BTN Count3 : {count}</button>
    </div>
  );
}
